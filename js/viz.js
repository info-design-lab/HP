...
! function() {
    ...
    function a(t, n, e, r, a, i) {
        ...
        var l = c(t, n),
            ...
            g = c(r, a),
            p = c(r, i);
        return "M" + l + u(t, f, e - n) + (n == a && e == i ? d(l, n, e, r) : d(g, e, a, r) + u(r, p, i - a) + d(l, n, i, t)) + "Z"
    }
    ...
    u.bP = function() {
        ...
        var i, u, o, s, c, d, l, f, g, p, h, y, m, v, A, x, k;
        return t.data = function(n) {
            ...
            return arguments.length ? (l = n, t) : "undefined" != typeof l ? l : 35
        }, t.min = function(n) {
            return arguments.length ? (f = n, t) : "undefined" != typeof f ? f : 0
        }, t.orient = function(n) {
            ...
            function a(n) {
                ...
                var a = d3.nest().key("primary" == n ? t.keyPrimary() : t.keySecondary()).rollup(function(t) {
                        return d3.sum(t, r)
                    }).entries(t.data()),
                    i = o(a, t.pad(), t.min(), 0, "vertical" == l ? t.height() : t.width()),
                    u = t.barSize();
                a.forEach(function(e, r) {
                    s[n].push({
                        x: "horizontal" == l ? (i[r].s + i[r].e) / 2 : "primary" == n ? u / 2 : t.width() - u / 2,
                        y: "vertical" == l ? (i[r].s + i[r].e) / 2 : "primary" == n ? u / 2 : t.height() - u / 2,
                        height: "vertical" == l ? (i[r].e - i[r].s) / 2 : u / 2,
                        width: "horizontal" == l ? (i[r].e - i[r].s) / 2 : u / 2,
                        part: n,
                        key: e.key,
                        value: e.value,
                        percent: i[r].p
            ...
            function i(n) {
                ...
                var a = d3.map(s[n], function(t) {
                    ...
                    i = d3.nest().key("primary" == n ? t.keyPrimary() : t.keySecondary()).sortKeys("primary" == n ? t.sortPrimary() : t.sortSecondary()).key("secondary" == n ? t.keyPrimary() : t.keySecondary()).rollup(function(t) {
                        return d3.sum(t, r)
                    }).entries(t.data());
                i.forEach(function(e) {
                    var r = a.get(e.key),
                        i = o(e.values, 0, 0, "vertical" == l ? r.y - r.height : r.x - r.width, "vertical" == l ? r.y + r.height : r.x + r.width),
                        u = t.barSize();
                    e.values.forEach(function(a, o) {
                        c[n].push({
                            x: "vertical" == l ? "primary" == n ? u / 2 : t.width() - u / 2 : (i[o].s + i[o].e) / 2,
                            y: "horizontal" == l ? "primary" == n ? u / 2 : t.height() - u / 2 : (i[o].s + i[o].e) / 2,
                            height: ("vertical" == l ? i[o].e - i[o].s : u) / 2,
                            width: ("horizontal" == l ? i[o].e - i[o].s : u) / 2,
                            part: n,
            ...
            function u() {
                ...
                return c.primary.map(function(t) {
                    var a = r.get(t.index);
                    return {
                        path: "vertical" === l ? n(t.x + t.width, t.y + t.height, a.x - a.width, a.y + a.height, a.x - a.width, a.y - a.height, t.x + t.width, t.y - t.height) : e(t.x - t.width, t.y + t.height, a.x - a.width, a.y - a.height, a.x + a.width, a.y - a.height, t.x + t.width, t.y + t.height),
                        primary: t.primary,
            ...
            var u = t.bars(),
                o = t.duration();
            y.selectAll(".subBars").data(u.subBars).transition().duration(o).attr("transform", function(t) {
                return "translate(" + t.x + "," + t.y + ")"
            }).select("rect").attr("x", n).attr("y", e).attr("width", r).attr("height", a), y.selectAll(".edges").data(u.edges).transition().duration(o).attr("d", function(t) {
                return t.path
            }).style("fill-opacity", t.edgeOpacity()), y.selectAll(".mainBars").data(u.mainBars).transition().duration(o).attr("transform", function(t) {
                return "translate(" + t.x + "," + t.y + ")"
            }).select("rect").attr("x", n).attr("y", e).attr("width", r).attr("height", a).style("fill-opacity", 0)
        ...
        function t(n) {
            g = n, n.each(function() {
                var n = d3.select(this),
                    ...
                    d = t.labelLocation(),
                    l = t.outerRadius();
                n.append("circle").attr("r", l).style("fill", "url(#vizgg3" + p + ")").attr("class", "face"), n.append("circle").attr("r", t.innerRadius()).style("fill", "url(#vizgg2" + p + ")").style("filter", "url(#vizgg5" + p + ")").attr("class", "innerFace");
                var f = n.append("g");
                f.selectAll("line").data(o).enter().append("line").attr("class", function(t) {
                    return c(t) ? "majorTicks" : "minorTicks"
                }).attr("x1", function(t) {
                    return l * (c(t) ? i : r) * Math.cos(e(t))
                }).attr("y1", function(t) {
                    return l * (c(t) ? i : r) * Math.sin(e(t))
                }).attr("x2", function(t) {
                    return l * (c(t) ? u : a) * Math.cos(e(t))
                }).attr("y2", function(t) {
                    return l * (c(t) ? u : a) * Math.sin(e(t))
                }), n.selectAll("text").data(o.filter(c)).enter().append("text").attr("class", "label").attr("x", function(t) {
                    return l * d * Math.cos(e(t))
                }).attr("y", function(t) {
                    return l * d * Math.sin(e(t))
        ...
        var n, e, r, a, i, o, c, d, l, f, g, p, h, y, m, v, A, x, k, b = {
            innerRadius: 20,
            outerRadius: 150,
            angleOffset: .7,
            startAngle: -1.5 * s,
        ...
        return t.scale = function() {
            ...
            return arguments.length ? (l = n, t) : "undefined" != typeof l ? l : b.duration
        }, t.ease = function(n) {
            return arguments.length ? (f = n, t) : "undefined" != typeof f ? f : b.ease
        }, t.value = function(n) {
        ...
        function u(t) {
            function n(t) {
                return r([P, O, t.startAngle, t.endAngle])
            }

            function e(t) {
                return a(P, t.startAngle, t.endAngle, P, t.endStartAngle, t.endEndAngle)
            }
            p = t, k || l(), t.each(function() {
        ...
        function s(t) {
            ...
            g.select("path").transition().duration(L).attrTween("d", s), g.select(".label").filter(function(t) {
                return "g" == t.type
            }).transition().duration(L).attrTween("x", l).attrTween("y", f).text(function(t) {
        ...
        function l() {
            ...
            }), g(x, z, R, void 0, B), k = [], x.filter(function(t) {
                return "g" == t.type
        ...
        function g(t, e, r, a, i) {
            var u = void 0 !== a,
                o = 0;
            if (u) {
                for (var s = !1; o < t.length; o++)
                    if (t[o].source == a && "g" == t[o].type) {
                        s = !0;
                        break
                    }
            ...
            var d = t.filter(function(t) {
                ...
                l = 2 * Math.PI - (u ? t[o].endAngle - t[o].startAngle + 2 * e : 0),
                f = u ? t[o].endAngle + e : i,
                g = d3.sum(d),
                p = n(d, e, r, 0 >= l ? 0 : l, g, u ? !0 : !1);
            c.slice(u ? 1 : 0).forEach(function(n) {
                var a = p * t[n].value,
                    i = (r > a ? r - a : 0) / 2;
                t[n].startAngle = f, t[n].endAngle = f + a, t[n].padAngle = i, t[n].percent = t[n].value / (g || 1), f += a + i + (t[n].skipPad ? 0 : e)
            })
        }
